...
public:
    ...
    NeuralNet(size_t numInputs, size_t numOutputs, size_t numSamples)
    {
        ...
        m_w1 = aix::tensor(aix::randf({numInputs, hlSize}),  {numInputs, hlSize}, true);
        m_b1 = aix::tensor(aix::randf({numSamples, hlSize}), {numSamples, hlSize}, true);
        m_w2 = aix::tensor(aix::randf({hlSize, numOutputs}), {hlSize, numOutputs}, true);
        m_b2 = aix::tensor(aix::randf({numSamples, numOutputs}), {numSamples, numOutputs}, true);
